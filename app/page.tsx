        ...
        <div className="max-w-7xl mx-auto w-full grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <Button
              asChild
              size="lg"
              className="bg-[#FF4D2E] hover:bg-[#e04327] text-white font-semibold px-8 py-6 text-base min-w-full"
            >
              <Link href="/login">Start Building</Link>
            </Button>
          </div>
                    ...
                    {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map(
                      (day, i) => (
                        <div key={day} className="text-center">
                          ...
                          <div
                            className={`h-16 rounded ${i === 2 ? "bg-[#FF4D2E]/30" : "bg-white/5"} border ${i === 2 ? "border-[#FF4D2E]/50" : "border-white/10"}`}
                          >
                            {i === 2 && (
                              <div className="p-1">
              ...
              <div className="absolute -bottom-4 -right-4 w-[280px] h-[180px] bg-white rounded-lg shadow-2xl transform rotate-[3deg] hover:rotate-0 transition-transform duration-500">
                <div className="p-4 h-full">
                  ...
                  <div className="text-xs text-gray-500 leading-relaxed">
                    Create, organize, and prioritize assignments with smart
                    deadlines.
                  </div>
